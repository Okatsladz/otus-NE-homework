...
2.2.1	В привилегированном режиме введём команду **show mac address-table** и нажмиём клавишу ввода.

![Консоль6](https://github.com/Okatsladz/otus-NE-homework/blob/main/Labs/lab2/Images/console6.png)  

_В таблице мак-адресов l2-адреса появляются при прохождении пакета в сторону порта. До того, как ввести команду, я отправил с PC-B на PC-A пинг. Соотвественно в таблицу мак-адресов добавилась информация о мак адресе, находящемся в интерфейсе шлюзового коммутатора, потом я ввёл команду отображения таблицы, и в ней появилась инфомация о соответсвии мак-адреса таблице. Затем, я направил пинг в сторону PC-B и повторно ввёл команду отображения таблицы. В ней уже появилась информация о новом мак адресе.

![Консоль7](https://github.com/Okatsladz/otus-NE-homework/blob/main/Labs/lab2/Images/console7.png)  

2.2.2. Ответ на вопрос, - **_Записаны ли в таблице МАС-адресов какие-либо МАС-адреса?:_**  
_Записаны мак адреса 0007.ecdc.8801, принадлежащий интерфейсу F0/1 на коммутаторе S1, сопоставленный с интерфейсом F0/1 коммутатора S2 и MAC-адрес компьютера PC-B: 0001.420C.2C1E _  

2.2.3. Ответ на вопрос, - **_Какие МАС-адреса записаны в таблице? С какими портами коммутатора они сопоставлены и каким устройствам принадлежат?:_**  
_0000.0c1d.5043_  

2.2.3. Ответ на вопрос, - **_Если не записаны МАС-адреса сетевых устройств в шаге 1, как можно определить, каким устройствам принадлежат МАС-адреса, используя только выходные данные команды show mac address-table? Работает ли это решение в любой ситуации?:_**  
