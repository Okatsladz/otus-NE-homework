...
#### Шаг 2. Изучение таблицы МАС-адресов коммутатора 
**a.**		Откроем командную строку на PC-A и PC-B и введём команду ipconfig /all.
![Консоль4](https://github.com/Okatsladz/otus-NE-homework/blob/main/Labs/lab2/Images/console4.png)     
_MAC-адрес компьютера PC-A: 0050.0FAC.AA00_  
_MAC-адрес компьютера PC-B: 0001.420C.2C1E_  
